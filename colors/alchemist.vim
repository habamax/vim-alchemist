...
" Last Updated: 28.03.2021 21:05:04
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#5f875f', '#af8700', '#5f87af', '#5f5f87', '#5f8787', '#6c6c6c', '#444444', '#d787af', '#87af87', '#d7af5f', '#87afd7', '#8787af', '#5fafaf', '#ffffff']
  if has('nvim')
